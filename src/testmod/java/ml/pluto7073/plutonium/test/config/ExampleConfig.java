...
public class ExampleConfig extends JointServerConfig {
    ...
    public static final ExampleConfig INSTANCE = new ExampleConfig(ExampleModTest.CONFIG_TYPE, false);
    ...
    public ExampleConfig(ServerConfigType<?> type, boolean copy) {
        super("plutonium_test", ExampleModTest.LOGGER, type, copy, ExampleModTest.SIMPLE_CONFIG_1);
    }
